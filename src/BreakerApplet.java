        ...
        java.awt.event.ActionListener
{
    ...
    /**
     Called to initialize the BreakerApplet. This is the main method in BreakerApplet
    ...
    */
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        for (int i = 0; i < nonRailColliderList.getSize(); i++)
        {
            ...
            nonRailColliderList.add(railColliderList.collisionCheck
            (nonRailCollider));
    ...
    private void startGame()
    {
        ...
        for (int i = 0; i <= 10; i++)
        {
            for (int j = 1; j <= 10; j++)
            {
                ...
                switch (num % 15)
                {
                    ...
                    case 5:
                        brick = 
                        new DuplicateBrick(i * 50, j * 40, 50, 20, panel);
                        break;
                    default:
        ...
        nonRailColliderList.add(new Ball((WIDTH - 10) / 2, HEIGHT - 75, 2, -2,
                Color.BLACK, panel));
   ...
   {//GEN-FIRST:event_panelKeyPressed
       switch (evt.getKeyCode())
       {
           ...
           case 86:
               ...
               break;
           case 32:
               if (paddle.getFiringmissile() && !Missile.isMissileInPlay && 
                       Missile.counter > 0)
               {
