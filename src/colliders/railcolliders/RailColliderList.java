...
/**
 A list class for rail colliders. Supports adding and removing RailColliders from the list, but more importantly
 allows for NonRailColliders to be checked against the entire list for collisions, wherein collisions are appropriately
...
public class RailColliderList
{
    ...
    /**
     Will run through all contained colliders, and if any collided with the passed NonRailCollider,
